...
test("First block and param should be equal to reference", tape => {
  ...
  // Set block count to 7 //
    ...
    tape.deepEqual(instance.param, expParam, "Param should be the same as in design");

    instance.encrypt(new Uint8Array(1));

    tape.deepEqual(instance.block, expBlock, "Block should be the same as in design");
